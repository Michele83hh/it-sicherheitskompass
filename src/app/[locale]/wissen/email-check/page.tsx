...
import { Mail, ChevronLeft, Loader2, CheckCircle2, AlertTriangle, XCircle, Search } from 'lucide-react';
...
const CHECK_KEYS = ['spf', 'dmarc', 'dkim', 'mx'] as const;

export default function EmailCheckPage() {
  const t = useTranslations('wissenPages.emailCheck');
        ...
        <Card className="mb-8">
          <CardContent className="pt-6">
            ...
            <div className="flex gap-3">
              ...
              />
              <Button onClick={handleCheck} disabled={loading || !domain.trim()} className="bg-emerald-500 hover:bg-emerald-600 text-white shadow-md shadow-emerald-500/20">
